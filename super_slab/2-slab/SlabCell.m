...
%% --- Input Arguments --- %%
wcal = ReadInput_slab('b2s_input.txt');
...
Rinv      = 1;
xyz_dir   = 2;
% basis1=[1 0 0];basis2=[0.5 2/3 0]; basis3=[0.5 1/3 1];
% bb=[basis1;basis2;basis3]; bb=bb';
% basis1=bb(1,:); basis2=bb(2,:); basis3=bb(3,:);
...
save slab_info.mat superatomps orbitps transform_matrix atomps bulkbasis BR hkl xyz_dir